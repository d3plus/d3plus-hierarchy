...
```sh
git clone git@github.com:your-username/d3plus-hierarchy.git
```
...
```html
<script src="../build/d3plus-hierarchy.full.js"></script>
<body>
...
```sh
https://d3plus.org/examples/d3plus-hierarchy/my-cool-example/
```
...
Push to your fork and [submit a pull request](https://github.com/d3plus/d3plus-hierarchy/compare/). At this point, you're waiting on us. We may suggest some changes or improvements or alternatives.
